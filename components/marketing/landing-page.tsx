...
export function MarketingLandingPage() {
  ...
  return (
    <div className="min-h-screen overflow-x-clip bg-[#f7faf7] text-[#0b1518] dark:bg-[#07161a] dark:text-slate-50">
...
function MarketingHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-900/10 bg-[#f7faf7]/88 backdrop-blur-xl dark:border-white/10 dark:bg-[#07161a]/88">
      <div className="container flex min-h-16 min-w-0 items-center gap-3 py-2">
        ...
        <div className="ml-auto flex min-w-0 items-center gap-2">
          ...
          <Button asChild className="hidden bg-[#0a3436] text-white hover:bg-[#123f42] sm:inline-flex dark:bg-teal-300 dark:text-slate-950 dark:hover:bg-teal-200">
...
function HeroSection() {
  const { locale, t } = useI18n();
  return (
    <section className="container grid min-h-[calc(100vh-4rem)] min-w-0 grid-cols-1 items-center gap-10 py-12 lg:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)] lg:py-16">
      <div className="w-[calc(100vw-2rem)] min-w-0 max-w-full sm:w-auto">
        ...
        <h1 className="overflow-wrap-anywhere mt-6 max-w-4xl break-words text-3xl font-semibold leading-tight tracking-normal text-slate-950 sm:text-5xl md:text-7xl dark:text-white">
          {t('landing.heroTitle')}
        </h1>
        <p className="overflow-wrap-anywhere mt-6 max-w-2xl break-words text-base leading-7 text-slate-600 sm:text-lg sm:leading-8 dark:text-slate-300">
...
function SectionIntro({ eyebrow, title, body }: { eyebrow: string; title: string; body: string }) {
  return (
    <div className="mx-auto max-w-3xl text-center">
      ...
      <h2 className="overflow-wrap-anywhere mt-4 break-words text-3xl font-semibold leading-tight tracking-normal text-slate-950 sm:text-4xl md:text-5xl dark:text-white">{title}</h2>
...
function FeatureSection({ feature, flipped }: { feature: FeatureBlock; flipped: boolean }) {
  ...
  return (
    <section id={feature.mockup} className={`grid grid-cols-1 items-center gap-8 lg:grid-cols-2 ${flipped ? 'lg:[&>*:first-child]:order-2' : ''}`}>
      <div>
        ...
        <h3 className="overflow-wrap-anywhere mt-3 break-words text-2xl font-semibold leading-tight tracking-normal text-slate-950 sm:text-3xl md:text-4xl dark:text-white">{feature.title}</h3>
...
function DashboardMockup() {
  ...
  return (
    <div className="relative w-full max-w-full overflow-hidden rounded-2xl border border-slate-900/10 bg-[#07161a] p-3 shadow-2xl dark:border-white/15">
      <div className="min-w-0 rounded-xl border border-white/10 bg-[#0c2228] p-4 text-white">
...
function FeatureMockup({ type }: { type: FeatureBlock['mockup'] }) {
  ...
  return (
    <div className="w-full max-w-full overflow-hidden rounded-2xl border border-slate-900/10 bg-white p-4 shadow-xl shadow-slate-900/5 dark:border-white/10 dark:bg-slate-950">
      {map[type]}
    </div>
  );
}
...
function ImportSection() {
  ...
  return (
    <section id="import" className="border-y border-slate-900/10 bg-[#eaf4f2] py-20 dark:border-white/10 dark:bg-white/[0.03]">
      <div className="container grid grid-cols-1 items-center gap-10 lg:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)]">
        <div>
          <Badge className="bg-white text-teal-800 dark:bg-teal-400/10 dark:text-teal-200" variant="secondary">{t('nav.importCenter')}</Badge>
          <h2 className="overflow-wrap-anywhere mt-4 break-words text-3xl font-semibold leading-tight tracking-normal text-slate-950 sm:text-4xl md:text-5xl dark:text-white">
...
function ImportMockup() {
  ...
  return (
    <div className="w-full max-w-full overflow-hidden rounded-2xl border border-slate-900/10 bg-white p-4 shadow-xl dark:border-white/10 dark:bg-slate-950">
      ...
      <div className="mt-4 overflow-x-auto rounded-lg border dark:border-white/10">
...
function MarketingFooter() {
  ...
  const footerGroups = [
    {
      ...
      links: [
        { label: t('landing.footer.journal'), href: '#journal' },
        { label: t('landing.footer.analytics'), href: '#analytics' },
        { label: t('landing.footer.calendar'), href: '#calendar' },
        { label: t('landing.footer.importCenter'), href: '#import' }
      ]
    },
    {
      title: t('landing.footer.resources'),
      links: [
        { label: t('landing.footer.demoWorkspace'), href: `/${locale}/login` },
        { label: t('landing.footer.sampleCsv'), href: '/sample-trades.csv' },
        { label: t('landing.footer.setupGuide'), href: '#resources' },
        { label: t('landing.footer.securityNotes'), href: '#resources' }
      ]
    },
    {
      title: t('landing.footer.company'),
      links: [
        { label: t('common.pricing'), href: `/${locale}/pricing` },
        { label: t('landing.footer.roadmap'), href: '#features' },
        { label: t('landing.footer.contact'), href: 'mailto:hello@tradeharbor.app' },
        { label: t('landing.footer.notAdvice'), href: '#resources' }
      ]
    }
  ];
  ...
  return (
    <footer className="border-t border-slate-900/10 bg-[#07161a] py-12 text-slate-300 dark:border-white/10">
      <div className="container grid grid-cols-1 gap-8 md:grid-cols-[1.2fr_0.8fr_0.8fr_0.8fr]">
        <div>
        ...
        {footerGroups.map(({ title, links }) => (
          <div key={title}>
            ...
            <div className="mt-3 grid gap-2 text-sm">
              {links.map((link) => <a key={link.label} href={link.href} className="text-slate-400 hover:text-white">{link.label}</a>)}
            </div>
          </div>
        ))}
      </div>
