...
export default async function LocalizedPlansPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <PlansWorkspace locale={activeLocale} messages={messages} plans={data.dailyPlans} templates={data.checklistTemplates} />;
}
